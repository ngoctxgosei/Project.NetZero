...
export class EmployeeServiceProxy {
     ...
     * @return Success
     */
    getEmployees(filter: string, sorting: string, maxResultCount: number, skipCount: number): Observable<ListResultDtoOfEmployeeListDto> {
    ...
    protected processGetEmployees(response: Response): Observable<ListResultDtoOfEmployeeListDto> {
        const status = response.status; 
     ...
     * @return Success
     */
    getEmployeeForEdit(id: number): Observable<GetEmployeeForEditOutput> {
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<GetEmployeeForEditOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<GetEmployeeForEditOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetEmployeeForEdit(response: Response): Observable<GetEmployeeForEditOutput> {
        const status = response.status; 
        ...
        return Observable.of<GetEmployeeForEditOutput>(<any>null);
    }

    /**
     * @return Success
     */
    createOrUpdateEmployee(input: CreateOrUpdateEmployeeInput): Observable<void> {
    ...
    protected processCreateOrUpdateEmployee(response: Response): Observable<void> {
        const status = response.status; 
     ...
     * @return Success
     */
    deleteEmployee(id: number): Observable<EmployeeListDto> {
    ...
    protected processDeleteEmployee(response: Response): Observable<EmployeeListDto> {
        const status = response.status; 
...
export class TaskServiceProxy {
     ...
     * @return Success
     */
    getAll(taskState: TaskState): Observable<ListResultDtoOfTaskListDto> {
     ...
     * @return Success
     */
    getTaskForEdit(id: number): Observable<GetTaskForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/Task/GetTaskForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<GetTaskForEditOutput>><any>Observable.throw(e);
                }
            } else
                return <Observable<GetTaskForEditOutput>><any>Observable.throw(response_);
        });
    }

    protected processGetTaskForEdit(response: Response): Observable<GetTaskForEditOutput> {
        const status = response.status; 
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetTaskForEditOutput.fromJS(resultData200) : new GetTaskForEditOutput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<GetTaskForEditOutput>(<any>null);
    }

    /**
     * @return Success
     */
    updateTask(input: TaskEditDto): Observable<TaskListDto> {
    ...
    protected processUpdateTask(response: Response): Observable<TaskListDto> {
        const status = response.status; 
     ...
     * @return Success
     */
    create(input: TaskEditDto): Observable<TaskListDto> {
     ...
     * @return Success
     */
    deleteTask(id: number): Observable<TaskListDto> {
    ...
    protected processDeleteTask(response: Response): Observable<TaskListDto> {
        const status = response.status; 
...
export class CreateOrUpdateEmployeeInput implements ICreateOrUpdateEmployeeInput {
    employee: EmployeeEditDto = new EmployeeEditDto();
...
export class GetTaskForEditOutput implements IGetTaskForEditOutput {
    ...
    init(data?: any) {
        if (data) {
            this.task = data["task"] ? TaskEditDto.fromJS(data["task"]) : <any>undefined;
        }
    }
...
export class TaskEditDto implements ITaskEditDto {
    id: number;
    title: string;
    description: string;
    state: TaskEditDtoState;
    tenantId: number;
    creationTime: moment.Moment;

    constructor(data?: ITaskEditDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TaskEditDto {
        let result = new TaskEditDto();
        result.init(data);
        return result;
    }
